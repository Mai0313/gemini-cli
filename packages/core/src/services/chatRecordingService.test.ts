...
describe('ChatRecordingService', () => {
  ...
  describe('getSubagentTrajectories', () => {
    it('should recursively collect subagent trajectories', async () => {
      ...
      const subagentDir = path.join(tempDir, 'chats');
      const subagentFile = path.join(subagentDir, `${subagentId}.json`);
      ...
      const subSubagentFile = path.join(subagentDir, `${subSubagentId}.json`);
